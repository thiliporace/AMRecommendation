...
struct SimplifiedAlbumModel: Equatable {
    ...
    static func == (lhs: SimplifiedAlbumModel, rhs: SimplifiedAlbumModel) -> Bool {
        return lhs.id == rhs.id // Only check the ID
    }
}

extension SimplifiedAlbumModel {
    init(from dto: SimplifiedAlbumModelDTO) {
