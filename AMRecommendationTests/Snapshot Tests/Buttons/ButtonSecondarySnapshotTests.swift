//
//  ButtonSecondarySnapshotTests.swift
...
class ButtonSecondarySnapshotTests: XCTestCase {
    ...
    override func setUp() {
        ...
        for name in names {
            guard let url = Bundle(for: ButtonSecondarySnapshotTests.self)
    ...
    private func createButtonsView() -> UIView {
        ...
        let normalButton = ButtonSecondary(buttonTitle: "retry")

        let pressedButton = ButtonSecondary(buttonTitle: "pressed")
        pressedButton.isHighlighted = true

        let disabledButton = ButtonSecondary(buttonTitle: "disabled")
    ...
    func testButtonSecondaryDynamicType() {
