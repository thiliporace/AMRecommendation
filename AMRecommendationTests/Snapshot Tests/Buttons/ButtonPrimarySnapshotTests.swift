...
class ButtonPrimarySnapshotTests: XCTestCase {
    ...
    private func createButtonsView() -> UIView {
        ...
        let normalButton = ButtonPrimary(buttonTitle: "connect spotify")

        let pressedButton = ButtonPrimary(buttonTitle: "pressed")
        pressedButton.isHighlighted = true

        let disabledButton = ButtonPrimary(buttonTitle: "disabled")
